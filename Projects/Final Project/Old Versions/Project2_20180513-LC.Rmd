...
#Make this paragraph form
For each of the below methods, we:
1. Built a full model, which included all of the predictor variables
2. Analyzed the accuracy of the full model using the appropriate tools for that method 3. Developed and evaluated one or more additional models using that method
4. Compared all models within each method and determied which was the "best"
...
#Can you guys write the first draft of this?
