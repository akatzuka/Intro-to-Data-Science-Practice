...
x_list = list(a="foo",b= 1:4,c= function(x){1.5*x^2})
...
y_list = list(a = 1:1000, b = 1001:2000)
...
# between 1 and 10.
mat1 = matrix(sample(1:10,100*3,replace = TRUE),nrow=100,ncol=3)

# set the column names of x to "x1", "x2", "x3"
mat1.dimnames = ("x1","x2","x3")
